    ...
    <table class="childthemewpdotcom">
        <tr>
            <td>
                <form method="post" action="options.php">
                    ...
                    <p><label><input size="76" type="checkbox" name="childthemewpdotcom_setting_x"
                            ...
                            Tick This Box If When You Inspect Your Source Code It Contains Your Parent Stylesheet
            ...
            <td>
                ...
                <p>
                    <a href="./options-general.php?page=childthemewpdotcom&childthemewpconfirm=Yes">Yes my child theme
                        works</a><br>
                    <a href="./options-general.php?page=childthemewpdotcom&childthemewpconfirm=No">No my child theme
                        does not work</a><br>
                    <?php
 				$problem = "";
				global $wpdb;
				...
				?></strong></p>
                <p>Your answer is important because it helps us to keep our child theme library up to date and bug free
                    for the WordPress community to use.</p>
                <hr>
                <?php
				if($problem == "flag")
				{
                ...
                <p><a href="https://childthemewp.com/ask-a-question/" target="_blank">Report your bug using this
                        form</a></p>
                <p>We can only fix bugs if you share more information with us. Please complete the form above so that we
                    can assist you and other WordPress users.</p>
                <?php
				}
				else
				{
...
<div id="footerlinktochildthemewp" style="text-align:center;">
    <p><a href="https://childthemewp.com" title="WordPress child theme created by childthemewp.com" target="_blank"
            style="font-size:10px;">www.childthemewp.com</a></p>
</div>
...
<div class="notice notice-success">
    <p><strong>Message from ChildThemeWP.com:</strong> Confirm your child theme work?
        <a href="./options-general.php?page=childthemewpdotcom&childthemewpconfirm=Yes">Yes my child theme works</a>
        &nbsp; or &nbsp;
        <a href="./options-general.php?page=childthemewpdotcom&childthemewpconfirm=No">No my child theme does not
            work</a></p>
</div>
<?php
		}
